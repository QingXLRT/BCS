...
//    /**
//     * Sets the id of the ballot.
//     *
//     * @param newID is the new id to be set to the ballot
//     */
...
//
//    /**
//     * Gets the names of the ranked candidates in a ballot and returns as a string.
//     *
//     * @return the ranked candidate names as a string.
//     */
//    public String getRankedCandidateNames() {
//        return Arrays.toString(rankedCandidateNames);
//    }
//
//    /**
//     * Gets the parties of the ranked candidates in the ballot and returns as a string.
//     *
//     * @return the ranked candidate parties as a string.
//     */
//    public String getRankedCandidateParties() {
//        return Arrays.toString(rankedCandidateParties);
//    }
//
//    /**
//     * Gets ranked candidate indices and returns them as a string.
//     *
//     * @return the ranking indices of the candidates in a ballot as a string.
//     */
//    public String getRankedCandidateIndices() {
//        return Arrays.toString(rankedCandidateIndices);
//    }
